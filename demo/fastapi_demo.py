...
rendering with TraceRite. Run with: fastapi dev fastapi_demo.py
...
async def index():
    ...
    <body>
        ...
        <a href="/variable-inspector" class="error-link">
            <strong>Variable Inspector</strong> - Test inspector with Foo (mixed member representations)
        </a>
    </body>
    </html>
    """
